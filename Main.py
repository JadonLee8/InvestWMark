...
print(binance.get_data("2020-01-01", "2020-02-01", "1d"))

Terra = Crypto("luna", "Terra", "binance")
print(Terra.get_data("2020-01-01", "2020-02-01", "1d"))  # none

xrp = Crypto("xrp", "xrp", "binance")
print(xrp.get_data("2020-01-01", "2020-02-01", "1d"))

cardano = Crypto("ada", "Cardano", "binance")
print(cardano.get_data("2020-01-01", "2020-02-01", "1d"))

solana = Crypto("sol", "Solana", "binance")
print(solana.get_data("2020-01-01", "2020-02-01", "1d"))  # either doesn't have data available for selected dates or
# API doesn't have same with Terra and avalanche

avalanche = Crypto("avax", "Avalanche", "binance")
print(avalanche.get_data("2020-01-01", "2020-02-01", "1d"))  # none

dogecoin = Crypto("doge", "DogeCoin", "binance")
print(dogecoin.get_data("2020-01-01", "2020-02-01", "1d"))

monero = Crypto("xmr", "Monero", "binance")
print(monero.get_data("2020-01-01", "2020-02-01", "1d"))
